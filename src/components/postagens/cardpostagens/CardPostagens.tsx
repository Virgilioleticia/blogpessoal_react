    ...
    <div className="border-slate-900 border flex flex-col rounded overflow-hidden justify-between">
      <div>
        ...
        <div className="p-4">
          ...
          <p>{post.texto}</p>
           <div className='mt-4'>
                    <p className='text-sm text-gray-950'>Tema: {post.tema?.descricao}</p>
      ...
      <Link to={`/editarPostagem/${post.id}`} className="w-full text-white bg-emerald-400 hover:bg-emerald-800 flex items-center justify-center py-2">
        ...
        <Link to={`/deletarPostagem/${post.id}`} className="text-white bg-emerald-400 hover:bg-emerald-800 w-full flex items-center justify-center">
