  ...
  return (
    <div className="container w-1/3 mx-auto">
      ...
      <div className="border flex flex-col rounded-2xl overflow-hidden justify-between">
        <header className="py-2 px-6 bg-emerald-800 text-white font-bold text-2xl">Postagem</header>
        <div className="p-4">
        ...
        <div className="flex">
          ...
          <button className="w-full text-slate-100 bg-emerald-400 hover:bg-emerald-800 flex items-center justify-center" onClick={deletarPostagem}>
            Sim
          </button>
        </div>
      </div>
